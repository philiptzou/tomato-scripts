...
route add -host 108.162.194.95 gw $VPNGW
route add -host 108.162.195.95 gw $VPNGW
...
route add -host 108.174.150.118 gw $VPNGW
...
route add -host 115.182.15.77 gw $VPNGW
...
route add -host 119.246.130.197 gw $VPNGW
...
route add -host 122.152.128.109 gw $VPNGW
route add -host 122.209.125.55 gw $VPNGW
route add -host 122.248.242.240 gw $VPNGW
route add -host 122.248.248.5 gw $VPNGW
route add -host 123.204.22.158 gw $VPNGW
...
route add -host 157.55.96.251 gw $VPNGW
route add -host 157.55.97.253 gw $VPNGW
...
route add -host 173.201.216.69 gw $VPNGW
...
route add -host 173.245.60.205 gw $VPNGW
route add -host 173.245.61.205 gw $VPNGW
route add -host 173.245.80.2 gw $VPNGW
route add -host 173.247.252.117 gw $VPNGW
route add -host 173.249.151.129 gw $VPNGW
route add -host 173.252.100.27 gw $VPNGW
...
route add -host 174.35.35.7 gw $VPNGW
route add -host 174.35.36.38 gw $VPNGW
...
route add -host 184.107.142.114 gw $VPNGW
route add -host 184.107.18.92 gw $VPNGW
...
route add -host 184.168.55.1 gw $VPNGW
...
route add -host 184.26.1.147 gw $VPNGW
route add -host 184.51.229.50 gw $VPNGW
route add -host 184.82.204.5 gw $VPNGW
route add -host 184.82.34.68 gw $VPNGW
route add -host 184.82.38.87 gw $VPNGW
route add -host 184.86.85.135 gw $VPNGW
route add -host 184.87.1.249 gw $VPNGW
route add -host 184.87.12.79 gw $VPNGW
...
route add -host 192.110.163.13 gw $VPNGW
...
route add -host 195.191.164.13 gw $VPNGW
...
route add -host 198.144.99.188 gw $VPNGW
...
route add -host 199.27.73.131 gw $VPNGW
...
route add -host 202.66.130.29 gw $VPNGW
...
route add -host 206.125.171.170 gw $VPNGW
route add -host 206.190.37.187 gw $VPNGW
route add -host 206.46.232.39 gw $VPNGW
route add -host 207.192.72.226 gw $VPNGW
route add -host 207.198.101.122 gw $VPNGW
...
route add -host 208.73.211.208 gw $VPNGW
...
route add -host 208.91.197.132 gw $VPNGW
...
route add -host 209.141.47.86 gw $VPNGW
route add -host 209.15.13.134 gw $VPNGW
route add -host 209.160.20.56 gw $VPNGW
route add -host 209.17.68.216 gw $VPNGW
...
route add -host 209.84.24.126 gw $VPNGW
...
route add -host 212.1.214.60 gw $VPNGW
...
route add -host 212.58.251.195 gw $VPNGW
route add -host 212.58.253.67 gw $VPNGW
...
route add -host 217.118.169.226 gw $VPNGW
...
route add -host 222.122.118.36 gw $VPNGW
...
route add -host 5.9.135.157 gw $VPNGW
...
route add -host 50.116.4.235 gw $VPNGW
route add -host 50.116.60.56 gw $VPNGW
...
route add -host 50.19.247.208 gw $VPNGW
...
route add -host 50.97.230.236 gw $VPNGW
route add -host 50.97.231.108 gw $VPNGW
route add -host 54.235.188.56 gw $VPNGW
route add -host 54.235.205.92 gw $VPNGW
route add -host 54.236.70.108 gw $VPNGW
...
route add -host 59.120.18.8 gw $VPNGW
...
route add -host 66.54.66.154 gw $VPNGW
...
route add -host 67.201.54.41 gw $VPNGW
...
route add -host 68.169.65.142 gw $VPNGW
...
route add -host 71.18.18.68 gw $VPNGW
...
route add -host 72.21.92.20 gw $VPNGW
route add -host 72.232.112.73 gw $VPNGW
route add -host 72.232.114.5 gw $VPNGW
...
route add -host 72.47.224.117 gw $VPNGW
...
route add -host 74.220.202.45 gw $VPNGW
...
route add -host 76.74.248.252 gw $VPNGW
...
route add -host 79.125.7.219 gw $VPNGW
route add -host 79.143.186.171 gw $VPNGW
route add -host 79.175.164.233 gw $VPNGW
route add -host 8.18.200.7 gw $VPNGW
route add -host 8.23.224.108 gw $VPNGW
route add -host 8.254.60.254 gw $VPNGW
route add -host 8.254.63.254 gw $VPNGW
route add -host 8.26.218.126 gw $VPNGW
route add -host 80.179.147.202 gw $VPNGW
...
route add -host 96.125.162.11 gw $VPNGW
...
route add -host 97.74.25.83 gw $VPNGW
route add -host 97.74.26.128 gw $VPNGW
route add -host 98.124.195.15 gw $VPNGW
...
route add -net 128.242.186.0/24 gw $VPNGW
...
route add -net 149.174.144.0/24 gw $VPNGW
route add -net 149.174.149.0/24 gw $VPNGW
...
route add -net 199.27.74.0/24 gw $VPNGW
...
route add -net 204.2.145.0/24 gw $VPNGW
route add -net 204.74.212.0/24 gw $VPNGW
route add -net 204.77.213.0/24 gw $VPNGW
route add -net 204.93.63.0/24 gw $VPNGW
route add -net 204.95.26.0/24 gw $VPNGW
route add -net 205.185.204.0/24 gw $VPNGW
route add -net 205.188.28.0/24 gw $VPNGW
route add -net 205.188.87.0/24 gw $VPNGW
route add -net 205.196.120.0/24 gw $VPNGW
route add -net 206.108.51.0/24 gw $VPNGW
route add -net 206.190.57.0/24 gw $VPNGW
route add -net 207.152.124.0/24 gw $VPNGW
...
route add -net 208.51.193.0/24 gw $VPNGW
...
route add -net 209.107.220.0/24 gw $VPNGW
...
route add -net 216.115.110.0/24 gw $VPNGW
...
route add -net 23.0.160.0/24 gw $VPNGW
...
route add -net 50.16.215.0/24 gw $VPNGW
...
route add -net 63.141.200.0/24 gw $VPNGW
route add -net 64.13.192.0/24 gw $VPNGW
route add -net 64.145.84.0/24 gw $VPNGW
...
route add -net 66.114.53.0/24 gw $VPNGW
...
route add -net 67.228.27.0/24 gw $VPNGW
...
route add -net 69.31.132.0/24 gw $VPNGW
route add -net 69.31.72.0/24 gw $VPNGW
...
route add -net 75.119.198.0/24 gw $VPNGW
...
route add -net 8.26.221.0/24 gw $VPNGW
...
route add -net 92.122.210.0/24 gw $VPNGW
route add -net 92.61.153.0/24 gw $VPNGW
route add -net 93.115.84.0/24 gw $VPNGW
route add -net 95.211.147.0/24 gw $VPNGW
route add -net 96.7.48.0/24 gw $VPNGW
route add -net 97.74.144.0/24 gw $VPNGW
route add -net 98.129.229.0/24 gw $VPNGW
route add -net 98.138.81.0/24 gw $VPNGW
##### end batch route #####
route add -host 108.174.2.100 gw $VPNGW
route add -net 107.162.0.0/16 gw $VPNGW
route add -net 108.160.160.0/20 gw $VPNGW
route add -host 72.52.4.91 gw $VPNGW
route add -host 119.235.235.44 gw $VPNGW
route add -net 162.212.40.0/21 gw $VPNGW
route add -net 118.155.230.0/24 gw $VPNGW
route add -net 199.96.160.0/22 gw $VPNGW
route add -net 184.72.0.0/15 gw $VPNGW
route add -net 107.20.0.0/14 gw $VPNGW
route add -net 174.129.0.0/16 gw $VPNGW
route add -net 23.20.0.0/14 gw $VPNGW
route add -net 54.240.0.0/12 gw $VPNGW
route add -host 128.199.191.142 gw $VPNGW
route add -net 72.246.0.0/15 gw $VPNGW
route add -host 204.45.120.82 gw $VPNGW
route add -host 50.62.11.160 gw $VPNGW
route add -net 106.187.61.0/24 gw $VPNGW
route add -net 192.30.252.0/22 gw $VPNGW
route add -net 209.85.128.0/17 gw $VPNGW
route add -net 31.13.70.0/24 gw $VPNGW
route add -net 31.13.79.0/24 gw $VPNGW
route add -host 198.35.26.106 gw $VPNGW
route add -net 207.171.160.0/19 gw $VPNGW
route add -host 142.4.214.161 gw $VPNGW
route add -host 174.36.196.168 gw $VPNGW
route add -host 74.208.170.59 gw $VPNGW
route add -host 210.61.56.32 gw $VPNGW
route add -host 210.61.56.25 gw $VPNGW
route add -host 106.187.40.13 gw $VPNGW
route add -host 61.244.110.199 gw $VPNGW
route add -host 74.220.126.92 gw $VPNGW
route add -net 23.0.0.0/12 gw $VPNGW
route add -net 192.33.24.0/21 gw $VPNGW
route add -net 202.177.192.0/20 gw $VPNGW
route add -net 72.21.80.0/20 gw $VPNGW
route add -host 106.187.93.16 gw $VPNGW
route add -host 204.10.32.68 gw $VPNGW
route add -net 204.10.32.0/22 gw $VPNGW
route add -host 178.33.44.27 gw $VPNGW
route add -host 23.10.8.118 gw $VPNGW
route add -host 23.46.133.29 gw $VPNGW
route add -host 23.33.37.79 gw $VPNGW
route add -net 23.32.0.0/11 gw $VPNGW
route add -net 184.50.0.0/15 gw $VPNGW
route add -net 212.58.224.0/19 gw $VPNGW
route add -net 54.224.0.0/12 gw $VPNGW
route add -net 173.252.64.0/18 gw $VPNGW
route add -net 50.16.0.0/14 gw $VPNGW
route add -net 23.72.0.0/13 gw $VPNGW
route add -host 207.241.224.2 gw $VPNGW
route add -host 207.241.226.190 gw $VPNGW
route add -net 192.229.128.0/17 gw $VPNGW
route add -net 37.187.0.0/16 gw $VPNGW
route add -net 216.58.192.0/19 gw $VPNGW
route add -host 103.245.222.223 gw $VPNGW
route add -host 190.93.247.237 gw $VPNGW
route add -host 190.93.246.237 gw $VPNGW
route add -host 91.190.218.18 gw $VPNGW
route add -host 148.251.50.164 gw $VPNGW
route add -host 216.34.181.96 gw $VPNGW
route add -net http://178.33.61.76/ gw $VPNGW
route add -host 178.33.61.76 gw $VPNGW
route add -host 5.196.44.172 gw $VPNGW
route add -net 210.155.101.128/25 gw $VPNGW
route add -net 23.64.0.0/14 gw $VPNGW
route add -host 198.140.134.76 gw $VPNGW
route add -host 207.96.174.152 gw $VPNGW
route add -net 50.112.0.0/16 gw $VPNGW
route add -host 199.96.57.7 gw $VPNGW
route add -net 61.244.110.0/24 gw $VPNGW
route add -host 23.235.47.193 gw $VPNGW
route add -host 199.27.79.193 gw $VPNGW
route add -host 173.241.248.219 gw $VPNGW
route add -host 194.132.198.165 gw $VPNGW
route add -host 194.132.196.212 gw $VPNGW
route add -host 194.132.196.98 gw $VPNGW
route add -host 194.68.30.162 gw $VPNGW
route add -host 194.68.30.146 gw $VPNGW
route add -host 194.68.30.114 gw $VPNGW
route add -host 104.16.55.15 gw $VPNGW
route add -host 104.16.54.15 gw $VPNGW
route add -host 103.245.222.249 gw $VPNGW
route add -net 190.93.240.0/20 gw $VPNGW
route add -host 141.101.114.59 gw $VPNGW
route add -host 198.35.26.96 gw $VPNGW
route add -host 68.234.31.77 gw $VPNGW
route add -host 68.234.25.109 gw $VPNGW
route add -host 96.44.178.158 gw $VPNGW
route add -host 157.188.12.32 gw $VPNGW
route add -net 131.103.20.172/31 gw $VPNGW
route add -host 131.103.20.167 gw $VPNGW
route add -host 131.103.20.168 gw $VPNGW
route add -net 216.239.32.0/19 gw $VPNGW
route add -net 199.16.156.0/22 gw $VPNGW
route add -host 54.219.162.117 gw $VPNGW
route add -host 54.67.3.127 gw $VPNGW
route add -net 199.96.56.0/21 gw $VPNGW
route add -host 52.1.215.192 gw $VPNGW
route add -host 169.253.219.225 gw $VPNGW
route add -host 174.129.25.170 gw $VPNGW
route add -host 162.159.245.89 gw $VPNGW
route add -net 162.158.0.0/15 gw $VPNGW
route add -net 54.192.0.0/16 gw $VPNGW
route add -net 54.160.0.0/12 gw $VPNGW
route add -host 198.41.184.78 gw $VPNGW
route add -host 198.41.185.78 gw $VPNGW
route add -host 192.241.240.89 gw $VPNGW
route add -host 72.167.131.126 gw $VPNGW
route add -net 94.176.148.0/24 gw $VPNGW
route add -net 89.46.100.0/22 gw $VPNGW
